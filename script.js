...
// var $newTask = $("#deadline").val();
// var $taskDate = $("#description").val();

//-------GETTING VALUES FROM INPUT TO ARRAY OF OBJECTS-------
function addTodo() {
  const todoText = document.querySelector("#myInput").value;
  const todoDate = document.querySelector("#deadline").value;
  const todoDesc = document.querySelector("#description").value;
